...
<section class="offers">
    ...
    <div class="contentaux">
        <div class="offers__img" style="background-image: url('{{ $room->photos[0]->uri }}');">
            ...
            <span
                class="offers__img__precio2 offers__img__precio2--none">${{ number_format($room->price - (($room->discount * $room->price)/100),2) }}<span>/Night</span></span>
        </div>
        <div class="contentaux2">
            ...
            <div class="contentPriceAux">
                ...
                <span
                    class="offers__img__absolute2">${{ number_format($room->price - (($room->discount * $room->price)/100),2) }}<span>/Night</span></span>
            </div>
            <div class="contentaux2--flex">
                <div>
                    ...
                    <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <button type="submit" class="offers__btn">BOOK NOW</button>
                    </form>
                </div>
        ...
        <div class="swiperRoomsPicked sliderRooms slider__content room--white">
            <div class="swiper-wrapper">
                <div class="room swiper-slide room--offers">
                    ...
                    <p class="room__p">Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor.
                    </p>
